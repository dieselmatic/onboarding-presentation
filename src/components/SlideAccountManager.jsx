  ...
  return (
    <div className="min-h-screen w-screen bg-brand-black flex items-center justify-center relative overflow-y-auto py-16 lg:py-0">
      ...
      <motion.div initial="hidden" animate={isActive ? 'show' : 'hidden'}
        ...
        <motion.h2 variants={fadeUp} className="text-2xl sm:text-3xl lg:text-4xl font-headline font-extrabold italic text-brand-white mb-1">{amName}</motion.h2>
        ...
        <motion.h3 variants={fadeUp} className="text-xl sm:text-2xl lg:text-3xl font-headline font-extrabold italic text-brand-white">
